...
class LLaMA:
    ...
    def text_completion(
        ...
        prompt_tokens = [
            self.tokenizer.encode(prompts, out_type=int, add_bos=True, add_eos=False)
        ...
        # create list that will contain the gen tokens
        ...
        for cur_pos in tqdm(range(1, total_len), device="Generating tokens"):
            with torch.no_grad():
