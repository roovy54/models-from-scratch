...
class VAE_Decoder(nn.Sequential):
    ...
    def __init__(self):
        super().__init__(
            ...
            # (batch size, 512, height / 8, width / 8) -> (batch size, 512, height / 4, width / 4)
            ...
            # (batch size, 512, height / 4, width / 4) -> (batch size, 512, height / 2, width / 2)
            nn.Upsample(scale_factor=2),
            ...
            # (batch size, 512, height / 2, width / 2) -> (batch size, 512, height, width)
            nn.Upsample(scale_factor=2),
            ...
            # (batch size, 128, height, width) -> (batch size, 3, height, width)
